...
import com.example.ike.gameapp.utils.HighScoreHelper;
import com.example.ike.gameapp.utils.SimpleAlertDialog;
import com.example.ike.gameapp.utils.SoundHelper;
...
public class MainActivity extends AppCompatActivity implements Balloon.BalloonListener {
    ...
    private static final int MIN_ANIMATION_DELAY = 500;//To determine amination speed
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToFullScreen();
        //This event listener is to get the height and widht
        ...
        //This sets the onClick listener to set to FullScreen Mode
    ...
    //These flags sets the launch to FullScreen mode
    ...
    private void updateDisplay(){
        ...
        mScoreDisplay.setText(String.valueOf(mLevel));
    }
